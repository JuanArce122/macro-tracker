    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 px-4 pb-6">
      <div className="w-full max-w-[420px] bg-bg-primary rounded-xl border border-border p-6 flex flex-col gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="font-display text-2xl tracking-[-0.02em] font-medium text-text-primary leading-tight">{title}</h2>
  ...
  return (
    <div className="flex flex-col flex-1 bg-bg-primary">
      ...
      <div className="px-5 pt-7 pb-4 flex items-center gap-3">
        ...
        <h1 className="font-display text-3xl tracking-[-0.02em] font-medium text-text-primary">Mis datos</h1>
      </div>
