            ...
            return (
              <div className="bg-bg-secondary border border-border rounded-xl p-5">
                ...
                <div className="grid grid-cols-4 gap-3 text-center">
                  ...
                  <div>
                    <p className="font-numbers text-2xl leading-none tabular-nums tracking-[0.01em] text-macro-protein">{m.proteina}<span className="font-body text-sm text-text-tertiary">g</span></p>
                    <p className="text-xs text-text-tertiary mt-1">prot</p>
                  </div>
                  <div>
                    <p className="font-numbers text-2xl leading-none tabular-nums tracking-[0.01em] text-macro-carbs">{m.carbs}<span className="font-body text-sm text-text-tertiary">g</span></p>
                    <p className="text-xs text-text-tertiary mt-1">carbs</p>
                  </div>
                  <div>
                    <p className="font-numbers text-2xl leading-none tabular-nums tracking-[0.01em] text-macro-fat">{m.grasa}<span className="font-body text-sm text-text-tertiary">g</span></p>
